    ...
    <div className="skills">
      ...
      <div className="skills-grid margin-top-medium">
        <div className="skills-div">
          <p className="skills-div-name">HTML</p>
          <img className="skills-div-img" src={"html5 (1).png"} alt="html" />
        </div>
        <div className="skills-div">
          <p className="skills-div-name">CSS</p>
          <img className="skills-div-img" src={"css-3.png"} alt="css" />
        </div>
        <div className="skills-div">
        ...
        <div className="skills-div">
          <p className="skills-div-name">JAVASCRIPT</p>
          <img
        ...
        <div className="skills-div">
          <p className="skills-div-name">RUBY</p>
          <img className="skills-div-img" src={"ruby.png"} alt="ruby" />
        </div>
        <div className="skills-div">
          <p className="skills-div-name">RUBY RAILS</p>
          <img
            className="skills-div-img"
        ...
        <div className="skills-div">
          <p className="skills-div-name">GIT</p>
          <img className="skills-div-img" src={"git.png"} alt="git" />
        </div>
        <div className="skills-div">
